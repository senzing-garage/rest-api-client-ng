...
export class BulkDataService {
    ...
    */
    ...
    /**
     * Analyze a bulk data set of records. (Supports SSE / Supports Web Sockets)
...
the [Senzing Generic Entity Specification](https://senzing.zendesk.com/hc/en-us/articles/231925448-Generic-Entity-Specification).
     ...
     */
    public analyzeBulkRecords(body: string | Blob | File | Array<{ [key: string]: any; }>, progressPeriod?: string | number, eofSendTimeout?: string | number, observe?: 'body', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<SzBulkDataAnalysisResponse>;
    public analyzeBulkRecords(body: string | Blob | File | Array<{ [key: string]: any; }>, progressPeriod?: string | number, eofSendTimeout?: string | number, observe?: 'response', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<HttpResponse<SzBulkDataAnalysisResponse>>;
    public analyzeBulkRecords(body: string | Blob | File | Array<{ [key: string]: any; }>, progressPeriod?: string | number, eofSendTimeout?: string | number, observe?: 'events', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<HttpEvent<SzBulkDataAnalysisResponse>>;
    public analyzeBulkRecords(body: string | Blob | File | Array<{ [key: string]: any; }>, progressPeriod?: string | number, eofSendTimeout?: string | number, observe: any = 'body', reportProgress: boolean = false, additionalHeaders: {[key: string]: string} = {} ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public analyzeBulkRecordsForm(body: Blob, progressPeriod?: number, eofSendTimeout?: number, observe?: 'body', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<SzBulkDataAnalysisResponse>;
    public analyzeBulkRecordsForm(body: Blob, progressPeriod?: number, eofSendTimeout?: number, observe?: 'response', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<HttpResponse<SzBulkDataAnalysisResponse>>;
    public analyzeBulkRecordsForm(body: Blob, progressPeriod?: number, eofSendTimeout?: number, observe?: 'events', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<HttpEvent<SzBulkDataAnalysisResponse>>;
    public analyzeBulkRecordsForm(body: Blob, progressPeriod?: number, eofSendTimeout?: number, observe: any = 'body', reportProgress: boolean = false, additionalHeaders: {[key: string]: string} = {}  ): Observable<any> {
...
the [Senzing Generic Entity Specification](https://senzing.zendesk.com/hc/en-us/articles/231925448-Generic-Entity-Specification).
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public loadBulkRecords(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe?: 'body', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<SzBulkLoadResponse>;
    public loadBulkRecords(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe?: 'response', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<HttpResponse<SzBulkLoadResponse>>;
    public loadBulkRecords(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe?: 'events', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<HttpEvent<SzBulkLoadResponse>>;
    public loadBulkRecords(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe: any = 'body', reportProgress: boolean = false, additionalHeaders: {[key: string]: string} = {} ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public loadBulkRecordsForm(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe?: 'body', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<SzBulkLoadResponse>;
    public loadBulkRecordsForm(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe?: 'body', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<SzBulkLoadResponse>;
    public loadBulkRecordsForm(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe?: 'response', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<HttpResponse<SzBulkLoadResponse>>;
    public loadBulkRecordsForm(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe?: 'events', reportProgress?: boolean, additionalHeaders?: {[key: string]: string}): Observable<HttpEvent<SzBulkLoadResponse>>;
    public loadBulkRecordsForm(body: string | Blob | File | Array<{ [key: string]: any }>, dataSource?: string, mapDataSources?: string, mapDataSource?: Array<string>, maxFailures?: number | string, progressPeriod?: number | string, eofSendTimeout?: number | string, observe: any = 'body', reportProgress: boolean = false, additionalHeaders: {[key: string]: string} = {} ): Observable<any> {
        ...
        return this.httpClient.request<SzBulkLoadResponse>('post',`${this.basePath}/bulk-data/load`,
            ...
            tap( (resp) => {
                console.log('BulkDataService.loadBulkRecordsForm: ', resp);
            })
        );
    }
}
