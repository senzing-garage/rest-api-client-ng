...
export class EntityGraphService {
    ...
    */
     ...
     * @param maxDegrees The maximum number of degrees to look for a path from the first entity to the last entity.  This defaults to &#x60;3&#x60; if not specified. If specified, the value must be greater-than zero (0) since a path cannot exist at zero degrees of separation.
