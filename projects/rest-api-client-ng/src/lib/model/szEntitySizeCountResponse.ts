...
/**
 * Extends the BaseResponse to add the fields for statistics representing the number of entities having a specific composite record count.
 */
export interface SzEntitySizeCountResponse extends SzBaseResponse { 
    data?: SzEntitySizeCount;
}