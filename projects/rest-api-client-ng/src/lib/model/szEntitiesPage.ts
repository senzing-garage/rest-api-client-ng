...
export interface SzEntitiesPage { 
    ...
    /**
     * The requested page size representing the maximum number of  entity ID's that were requested to be returned.
     */
    pageSize: number;
    /**
    ...
    /**
     * An array of entity ID's identifying the entities for the page. The entity ID array will be in ascending order.
     */
