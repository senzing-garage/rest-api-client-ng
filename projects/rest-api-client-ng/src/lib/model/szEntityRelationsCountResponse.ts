...
/**
 * Extends the BaseResponse to add the fields for statistics representing the number of entities having a specific number of entity relations.
 */
export interface SzEntityRelationsCountResponse extends SzBaseResponse { 
    data?: SzEntityRelationsCount;
}