...
import { SzSummaryStats } from './szSummaryStats';

/**
 * Extends the BaseResponse to add the fields for statistics representing summary statistics for every configured data source.
 */
export interface SzSummaryStatsResponse extends SzBaseResponse { 
    data?: SzSummaryStats;
}