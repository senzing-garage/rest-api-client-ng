...
import { SzEntitySizeBreakdown } from './szEntitySizeBreakdown';
import { SzLinks } from './szLinks';
import { SzMeta } from './szMeta';

/**
 * Extends the BaseResponse to add the fields for statistics representing counts of entities having each distinct composite number of records.
 */
export interface SzEntitySizeBreakdownResponse extends SzBaseResponse { 
    data?: SzEntitySizeBreakdown;
}