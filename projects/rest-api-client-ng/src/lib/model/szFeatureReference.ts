 ...
 */
export interface SzFeatureReference { 
    /**
     * The internal feature ID identifying the feature so that it might be identified and referenced.
     */
    internalId?: number;
    /**
     * The optional associated usage type (e.g.: \"HOME or \"WORK).  This is the usage type with which the record loaded the feature (if any). Other records in the same entity may have the same feature with a different usage type.
     */
    usageType?: string;
}