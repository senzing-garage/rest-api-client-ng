...
/**
 * Describes a record that belongs to a virtual entity.  This identifies the record as well as its internal ID to understand which records in the virtual entity are considered to be duplicates of each other.
 */
export interface SzVirtualEntityRecord { 
    /**
    ...
    recordId?: string;
    /**
     * The unique internal ID for the record.  Those records having the same value for this field are effectively identical for the purpose of entity resolution and automatically bound together.
     */
    internalId?: string;
}