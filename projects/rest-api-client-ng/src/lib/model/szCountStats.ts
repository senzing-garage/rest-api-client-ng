...
export interface SzCountStats { 
    ...
    /**
     * An array of `SzSourceCountStats` describing the entity and record counts by data source.
     */
    dataSourceCounts: Array<SzSourceCountStats>;
}