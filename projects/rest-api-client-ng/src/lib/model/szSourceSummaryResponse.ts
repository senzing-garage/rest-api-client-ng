...
/**
 * Extends the BaseResponse to add the fields for statistics representing summary statistics for a single data source versus itself and every other data source.
 */
export interface SzSourceSummaryResponse extends SzBaseResponse { 
    data?: SzSourceSummary;
}