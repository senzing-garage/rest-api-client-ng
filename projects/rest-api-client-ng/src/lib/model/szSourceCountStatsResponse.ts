...
import { SzSourceCountStats } from './szSourceCountStats';

/**
 * Extends the BaseResponse to add the fields for statistics representing counts of entities and records for a specific data source.
 */
export interface SzSourceCountStatsResponse extends SzBaseResponse { 
    data?: SzSourceCountStats;
}