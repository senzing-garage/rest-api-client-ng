 ...
 */
import { SzVirtualEntityRecord } from './szVirtualEntityRecord';
 ...
 */
export interface SzVirtualEntity { 
    /**
    ...
    /**
     * Indicates if the virtual entity consists of a a single record or one or more effectively identical records (i.e.: with the same internal ID) with a value of `true`.  If this virtual entity comprises multiple distinct records then this is `false`.
     */
    singleton?: boolean;
    /**
     * The array of `SzVirtualEntityRecords` identifying the constituent records of the virtual entity.  Those records in the array with the same `internalId` property are effectively identical for the purposes of entity resolution.
     */
