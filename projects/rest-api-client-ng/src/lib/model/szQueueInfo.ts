 ...
 */
export interface SzQueueInfo { 
    /**
     * A description of the configured queue and its purpose.
     */
    description?: string;
    /**
     * A description of the provider type for the queue implementation.
     */
    providerType?: string;
    /**
     * The approximate number of messages on the queue (if known).  This is omitted if not known.
     */
    messageCount?: number;
}