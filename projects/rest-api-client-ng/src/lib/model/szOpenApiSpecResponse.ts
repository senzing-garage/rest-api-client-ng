...
/**
 * Extends the BaseResponse to describe a response containing the Open API specification in JSON format as the data.
 */
export interface SzOpenApiSpecResponse extends SzBaseResponse { 
    /**
