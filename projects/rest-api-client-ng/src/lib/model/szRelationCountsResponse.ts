...
import { SzRelationCountsResponseData } from './szRelationCountsResponseData';

/**
 * Extends the `BaseResponse` to add the fields for statistics representing cross-summary statistics on relationships of a specific type between two specific data sources.
 */
export interface SzRelationCountsResponse extends SzBaseResponse { 
    data?: SzRelationCountsResponseData;
}