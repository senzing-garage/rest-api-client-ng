...
import { SzEntitiesPage } from './szEntitiesPage';
import { SzLinks } from './szLinks';
import { SzMeta } from './szMeta';

/**
 * Extends the BaseResponse to add the fields describing a list of entity ID's that is \"paged\" with a boundary, a page size and a  total entity count.
 */
export interface SzPagedEntitiesResponse extends SzBaseResponse { 
    data?: SzEntitiesPage;
}