...
import { SzEntityRelationsBreakdown } from './szEntityRelationsBreakdown';
import { SzLinks } from './szLinks';
import { SzMeta } from './szMeta';

/**
 * Extends the BaseResponse to add the fields for statistics representing counts of entities having each distinct number of entity relations.
 */
export interface SzEntityRelationsBreakdownResponse extends SzBaseResponse { 
    data?: SzEntityRelationsBreakdown;
}